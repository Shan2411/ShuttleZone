...
CREATE TABLE `courts` (
    ...
    `status` ENUM('Operational', 'Maintenance', 'Out of Service', 'In Use') DEFAULT 'Operational',
...
-- Court A:
('123', 'Court A', 'Maintenance', 35.00, 15.00, 15.00),

-- Court B: 
('1234', 'Court B', 'Out Of Service', 25.00, 15.00, 10.00),

-- Court C: 
('12345', 'Court C', 'Operational', 15.00, 15.00, 5.00),

-- Court D: 
('123456', 'Court D', 'Maintenance', 20.00, 15.00, 10.00);