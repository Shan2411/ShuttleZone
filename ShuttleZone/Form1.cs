    ...
    namespace ShuttleZone
    {
        ...
        private void InventoryBtn_Click(object sender, EventArgs e)
            ...
            private void PendingPaymentsBtn_Click(object sender, EventArgs e)
            {
                ...
                if (!_views.ContainsKey(typeof(UC_Pending)))
                {
                    var pendingUC = new UC_Pending(rentHistoryUC);
                    pendingUC.Dock = DockStyle.Fill;
                    _views[typeof(UC_Pending)] = pendingUC;
                }

                DynamicContentPanel.Controls.Clear();
                DynamicContentPanel.Controls.Add(_views[typeof(UC_Pending)]);
            }
